...
class RegistrationController {
	...
	$role = $_POST["roleSLCT"];
	$first_name = $_POST["firstnameTXT"];
	$middle_name = $_POST["middlenameTXT"];
	$last_name = $_POST["lastnameTXT"];
	$email = $_POST["emailTXT"];
	$username = $_POST["usernameTXT"];
	$password = $_POST["passwordTXT"];
	$birthday = $_POST["birthyearSLCT"]."-".$_POST["birthmonthSLCT"]."-".$_POST["birthdaySLCT"];
	$gender = 0; //////////////////////////////////////////////////////////////////////////////////////////////$_POST["genderRB"];
	$country = $_POST["countrySLCT"];
	$city = $_POST["cityTXT"];
	$address_1 = $_POST["address_1TXT"];
	$address_2 = $_POST["address_2TXT"];
	$zip = $_POST["zipTXT"];
	$mobile = $_POST["mobileTXT"];
	$homephone = $_POST["homephoneTXT"];
	$fax = $_POST["faxTXT"];
	$security_question_1 = $_POST["security_question_1SLCT"];
	$security_answer_1 = $_POST["security_answer_1TXT"];
	$security_question_2 = $_POST["security_question_2SLCT"];
	$security_answer_2 = $_POST["security_answer_2TXT"];
	$security_question_3 = $_POST["security_question_3SLCT"];
	$security_answer_3 = $_POST["security_answer_3TXT"];
	
	$user = new UserEntity(-1, $role, $first_name, $middle_name, $last_name, $email, $username, $password, $birthday, $gender, $country, $city, $address_1, $address_2, $zip, $mobile, $homephone, $fax, $security_question_1, $security_answer_1, $security_question_2, $security_answer_2, $security_question_3, $security_answer_3);
    ...
    function CreateRegistrationForm(/*arugements*/)
    {
