				...
				<div class="shell">
					<div class="header-inner">
						...
						<div class="header-cnt">
							...
							<p>
								<span class="mobile">Kamello is the first and only website providing E-Learning and Educational Social Network. Powered and Developed by Menoon Inc.</span>
